...
if __name__ == "__main__":
    ...
    # in GANs it has been shown (c.f. DCGAN paper) that it's better to set beta1 and beta2 to 0.5
    parser.add_argument('--beta1', default=0.5, type=float, help='Adam optimizer beta1') # was 0.9
    parser.add_argument('--beta2', default=0.5, type=float, help='Adam optimizer beta2') # was 0.999 

    parser.add_argument('--lambda_D', default=1, type=float, help='Weight of lambda_D')
    parser.add_argument('--lambda_G', default=1, type=float, help='Weight of lambda_G')
    parser.add_argument('--lambda_PCP', default=0, type=float, help='Weight of lambda_PCP')
    
    parser.add_argument('--norm_type', type=str, default='bn2d', help='Normalization [bn1d | bn2d | in2d | in2d | none]')


    parser.add_argument('--dset_dir', default='E:/data', type=str, help='dataset directory') # was E:/data
